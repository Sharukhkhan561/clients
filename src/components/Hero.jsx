...
const Hero = () => {
  ...
  return (
    ...
    <div className='flex flex-col items-start gap-2'>
        ...
        <input type="date"  id="pick-up date" min={new Date().toISOString().split("T")[0]} className="text-sm text-gray-500" required/>
    </div>
    <div className='flex flex-col items-start gap-2'>
        <label htmlFor="pick-up date"> Return Date</label>
        <input type="date"  id="pick-up date"  className="text-sm text-gray-500" required/>
    </div>
    <button >
